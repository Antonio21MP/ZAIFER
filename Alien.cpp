...
{
    al_init_image_addon();
    enemy_image.push_back(al_load_bitmap("alien_01.png"));
    enemy_image.push_back(al_load_bitmap("alien_02.png"));
    enemy_image.push_back(al_load_bitmap("alien_01.png"));
}
void Alien::act(int frame, int velocidad)
{
    if(frame%10==0){
            if(sprite_enemy<2){
                sprite_enemy++;
